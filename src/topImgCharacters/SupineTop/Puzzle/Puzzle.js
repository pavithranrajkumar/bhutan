...
const Puzzle = ({ onComplete, resetPuzzleCard }) => {
  ...
  const dropZoneSpecifications = [
    { id: 1, top: "79.5%", left: 473, width: 57, height: 30 }, // Shoulder R
    { id: 2, top: "73.8%", left: 502, width: 59, height: 42 }, // Elbow R
    { id: 3, top: "72.5%", left: 424, width: 61, height: 40 }, // Hand R
    { id: 4, top: "79.8%", left: 428.5, width: 61, height: 60 }, // Heart
    { id: 5, top: "80%", left: 355, width: 66, height: 50 }, // Hip L
    { id: 6, top: "78%", left: 251, width: 115, height: 80 }, // Knee L
    { id: 7, top: "81%", left: 173, width: 92, height: 54 }, // Foot R
    { id: 8, top: "86.5%", left: 541, width: 50, height: 53 }, // Elbow L
    { id: 9, top: "81%", left: 576, width: 56, height: 64 }, // Hand L
    { id: 10, top: "82.5%", left: 481, width: 56, height: 59 }, // Shoulder L
    { id: 11, top: "82.6%", left: 350, width: 80, height: 48 }, // Hip R
    { id: 12, top: "75%", left: 246, width: 90, height: 60 }, // Knee R
    { id: 13, top: "85.8%", left: 177, width: 90, height: 70 }, // Base1 or Foot L
  ];
