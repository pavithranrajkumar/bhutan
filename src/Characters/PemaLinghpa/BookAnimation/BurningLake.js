...
import BurningLakeBookImg2 from "../../../assests/BookPages/BurningLakeComicBook/Comic Pg 1.png";
import BurningLakeBookImg3 from "../../../assests/BookPages/BurningLakeComicBook/Comic Pg 2.png";
import BurningLakeBookImg4 from "../../../assests/BookPages/BurningLakeComicBook/Comic Pg 3.png";
import BurningLakeBookImg5 from "../../../assests/BookPages/BurningLakeComicBook/Comic Pg 4.png";
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className={styles.page}>
          <img src={BurningLakeBookImg4} alt="Inner Left Page" />
        </div>
          <div className={styles.page}>
          <img src={BurningLakeBookImg5} alt="Inner Right Page" />
        </div>
          <div className={styles.page}>
            <img src={BurningLakeBookImg1} alt="Comic Book Cover" />
          </div>
