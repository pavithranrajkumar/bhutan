...
const PemaLingpa = () => {
  ...
  const [showMonstariesAndTemples, setShowMonstariesAndTemples] = useState(false);
  const [showMonstariesAndTemplesImgs, setShowMonstariesAndTemplesImgs] = useState(false);
  ...
  const [showBurningLakeBookImage, setShowBurningLakeBookImage] = useState(false);
  ...
  const getIconColor = () => {
    if (showHistoricDetails || showLineageCard || showRevelationsCard || showLegacyCard) return '#ffd9bc';
  };

  const getIconBgColor = () => {
    if (showHistoricDetails || showLineageCard || showRevelationsCard || showLegacyCard) return '#380100';
  };
  ...
  return (
    <motion.div className={styles.pemaContainer} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1.6, ease: 'easeOut' }}>
      <motion.div
      ...
      <motion.div
        className={nameCardSubtitle ? styles.nameCardSubtitlecard : styles.pemaNameCard}
      ...
      >
        ...
        <div className={nameCardSubtitle ? styles.nameCardtitle : styles.pemaNameCardTitle}>
          <div className={styles.namedCardText}>{nameCardText}</div>
        </div>
        {nameCardSubtitle && <div className={styles.nameCardSubtitle}>{nameCardSubtitle}</div>}
      </motion.div>
      ...
      {showCards && (
        ...
        >
          ...
          <motion.div
            ...
            transition={{ duration: 1 }}
          >
            <div className={styles.CardsContainerText}>REVALATIONS BY PEMA LINGPA</div>
          </motion.div>
          <motion.div
      ...
      {showHistoricDetails && (
        <>
          <Card
            ...
            content={PREMA_LINGPA_INFORMATION[language].historicBackground.content}
            showIntro={showIntro}
          ...
          <motion.div
            ...
            transition={{ duration: 1 }}
          >
            <FontAwesomeIcon icon={faChevronRight} className={styles.HistoricIcon} />
          </motion.div>
        </>
      )}
      ...
      {showLineageCard && (
        <div>
          ...
          <div className={styles.FamilCard}>
            <div className={styles.FamilyHeader} onClick={handleFamilyHeaderClick}>
              <p>PEMA LINGPA</p>
            </div>
            ...
            {showFirstLevel && (
              <>
                ...
                <div className={styles.SonsList}>
                  <div
                    className={`${styles.SonsTree} ${activeCard === 'DrakpaGyalpos' ? '' : styles.faded}`}
                  ...
                  <div
                    className={`${styles.SonsTree} ${activeCard === 'DawaGyaltshen' ? '' : styles.faded}`}
                  ...
                  <div
                    className={`${styles.SonsTree} ${activeCard === 'KuengaWangpo' ? '' : styles.faded}`}
                  ...
                  <div className={`${styles.SonsTree} ${activeCard === 'Sangda' ? '' : styles.faded}`} onClick={() => handleTreeCardClick('Sangda')}>
                ...
                {activeCard === 'DawaGyaltshen' && (
                  ...
                  >
                    <div>
                      ...
                      <div className={styles.DawaGyaltshenSonsHorizontalLine}></div>
                      <div className={styles.DawaGyaltshenDownSonsVerticalLine}></div>
                ...
                {activeCard === 'KuengaWangpo' && (
                  ...
                  >
                    <div className={styles.DawaGyaltshenCardContainer}>
                      ...
                      <div className={styles.KuengaWangpoSonsHorizontalLine}></div>
      ...
      {showRevelationsCard && (
        <>
          ...
          <div className={styles.RevelationsSideCards}>
            <div className={styles.NaringDragCard} onClick={handleNaringDragCardClick}>
              <div className={styles.RevalationSideCardTextContainer}>
                <div className={styles.RevelationsSideCardsfrst}>Revelations at</div>
            ...
            <div className={styles.BurningLakeCard} onClick={handleBurningLakeCardClick}>
              <div className={styles.RevalationSideCardTextContainer}>
                <div className={styles.RevelationsSideCardsfrst}>Revelations at</div>
      ...
      {showNaringDragBook && (
        <>
          <div className={showNaringDragBookImage ? styles.BookOpen : styles.NaringDragCardBookContainer}>
            {/* <img
            ...
            <img
              ...
              onClick={handleNaringDragBookImageClick}
            /> */}
            <img src={showNaringDragBookImage ? BookOpen : NaringDrag} alt='NaringDrag' onClick={handleNaringDragBookImageClick} />
          </div>

          <div className={styles.NaringDragCardBookBurningLakeCardContainer} onClick={handleBurningLakeCardClick}>
            <div className={styles.RevelationsSideCardsfrst}>Revelations at</div>
            <div className={styles.RevelationsSideCardsScnd}>BURNING LAKE</div>
          </div>
        </>
      ...
      {showBurningLakeBook && (
        <>
          <div className={showNaringDragBookImage ? styles.BookOpen : styles.NaringDragCardBookContainer}>
            <img src={showNaringDragBookImage ? BookOpen : ComicBook} alt='NaringDrag' onClick={handleNaringDragBookImageClick} />
          </div>
          <div className={styles.NaringDragCard} onClick={handleNaringDragCardClick}>
            <div className={styles.RevelationsSideCardsfrst}>Revelations at</div>
            <div className={styles.RevelationsSideCardsScnd}>NARING DRAG</div>
      ...
      {showNaringDragCard && (
        <>
          ...
          <div className={styles.NaringDragCardBook}>
            <img src={NaringDrag} alt='NaringDrag' onClick={NaringDragBookClick} />
      ...
      {showBurningLakeCard && (
        <>
          <Card
            ...
            showIntro={showIntro}
          />
          <div className={styles.NaringDragCardBook} onClick={BurningLakeBookClick}>
      ...
      {showLegacyCard && (
        <>
          ...
          <div className={styles.PelingCard} onClick={PelingCardClick}>
            ...
            <div className={styles.PelingSideCardsScnd}>MONASTERIES & TEMPLES</div>
          </div>
      ...
      {showMonstariesAndTemples && (
        <>
          <Card
            ...
            showIntro={showIntro}
          />
          <div className={styles.MonsTemplesCardBook} onClick={PelingCardImageClick}>
        ...
        <>
          <div className={styles.MonstariesAndTemplesImgsContainer}>
            ...
            <div className={styles.MonstariesAndTemplesImgsContainerFrth}>
              ...
              <div className={styles.MonstariesAndTemplesImgsPelingDanceCard} onClick={PelingDanceClick}>
                <div className={styles.PelingSideCardsfrst}>Peling</div>
                <div className={styles.PelingSideCardsScnd}>DANCE</div>
              </div>
            </div>
      ...
      {(showDetails ||
        ...
        showIcons && (
          ...
          >
            <FontAwesomeIcon icon={faHome} className={styles.icon} style={{ color: getIconColor(), background: getIconBgColor() }} />
          </motion.div>
        )}

      {(showMonstariesAndTemplesImgs || showBurningLakeBook || showNaringDragBook) && showIcons && (
        <motion.div
        ...
        >
          <FontAwesomeIcon icon={faChevronLeft} className={styles.PreviousIcon} style={{ color: getIconColor(), background: getIconBgColor() }} />
        </motion.div>
      )}
    </motion.div>
  );
